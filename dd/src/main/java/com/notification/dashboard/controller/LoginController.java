...
public class LoginController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // CRITICAL FIX: Show login form by default
    ...
    private void setupLoginForm() {
        ...
        // FIXED: Change from showRegistrationForm() to handleRegistration()
        if (registerLink != null) {
            registerLink.setOnAction(event -> handleRegistration());
        }
    ...
    private void setupRegistrationForm() {
        ...
        // FIXED: Ensure registerButton is properly linked
        if (registerButton != null) {
    ...
    private void handleRegistration() {
        // NEW FIX: First show the registration form before collecting data
        showRegistrationForm();

        // Check if we're just switching forms or actually submitting
        if (registerForm != null && registerForm.isVisible()) {
            // We're showing the form, don't process registration yet
            return;
        }
        ...
        String role = regUserRole.isSelected() ? "user" : "admin";
    ...
    private void showRegistrationForm() {
        ...
        if (loginForm != null) {
            ...
            loginForm.setManaged(false);  // FIX: Add this line
        }

        if (registerForm != null) {
            registerForm.setVisible(true);
            registerForm.setManaged(true);  // FIX: Add this line

            // Use Platform.runLater to ensure focus works
            Platform.runLater(() -> {
                if (regUsernameField != null) {
    ...
    private void showLoginForm() {
        if (registerForm != null) {
            registerForm.setVisible(false);
            registerForm.setManaged(false);  // FIX: Add this line
        }

        if (loginForm != null) {
            loginForm.setVisible(true);
            loginForm.setManaged(true);  // FIX: Add this line
